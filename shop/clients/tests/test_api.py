...
class ClientsApiTestCase(APITestCase):
    ...
    def test_clients_view_performance(self):
        user_1 = User.objects.create_user(username='manson', email='manson@google.com', first_name='Vasya',
                                          last_name='Entrop')
        Client.objects.create(user=user_1, gender='M', age=27, phone='+75642185479', full_address='Moscow')
        ...
        user_2 = User.objects.create_user(username='sara', email='sara@google.com', first_name='Sara',
                                          last_name='Maddison')
        Client.objects.create(user=user_2, gender='F', age=30, phone='+72657841598', full_address='Paris')
